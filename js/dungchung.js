...
function logIn(form) {
    ...
    var newUser = new User(name, pass);new User(name, pass);
	...
	<div class="top-nav group">
        <section>
            <div class="social-top-nav">
                <a class="fa fa-facebook" href="https://www.facebook.com/thanh.at.109313" target="_blank"></a>
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Thành Đạt Mobile</a> - All Copyrights reserved © 2025 - Designed by
